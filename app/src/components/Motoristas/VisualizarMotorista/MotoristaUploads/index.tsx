...
import classes from './motoristaUploads.module.scss';

type MotoristaUploadsProps = {
    motorista: Motorista;
};

const url = process.env.API_URL;

export default function MotoristaUploads({ motorista }: MotoristaUploadsProps) {
    ...
    const mutationCreate = useMutation({
        ...
        onSuccess: () => {
            ...
            queryClient.invalidateQueries({ queryKey: ['motorista' + motorista.id] });
        },
        onError: (error) => {
            notifications.show({
                title: 'Erro',
                            ...
                            children: (
                                <Form
                                    ...
                                    onSubmit={({ data }) => {
                                        ...
                                        formData.append('motoristaId', motorista.id.toString());
                                        modals.close('upload');
