...
class CreateUsuarioDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { nome: { required: true, type: () => String }, email: { required: true, type: () => String }, senha: { required: true, type: () => String }, setorId: { required: true, type: () => Number } };
    }
}
...
__decorate([
    (0, class_validator_1.IsInt)({ message: 'setorId deve ser um inteiro' }),
    __metadata("design:type", Number)
], CreateUsuarioDto.prototype, "setorId", void 0);
